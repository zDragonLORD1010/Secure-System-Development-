...
print(string[0:5:1]) # [:5] Выводит первые 5 символов

print(string[0:-2]) # [:-2] Выводит всю строку кроме последних двух символов

print(string[0::2]) # [::2] Выводит все четные числа

print(string[1::2]) # Выводит все нечетные числа

print(string[::-1]) # Выводит строку наоборот

print(string[::-2]) # Выводит чтроку наоборот через 1

print(len(string)) # Выводит длинну строки
